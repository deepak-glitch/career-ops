#!/usr/bin/env node
// Overnight 2026-05-04 PDF generator — 2 PDFs (#503 Closure + #504 H.I.G. Capital).
...
const ROLES = [
  {
    slug: 'closure-founding-ai-engineer-2026-05-04',
    location_suffix: 'US-based, F-1 OPT, open to NY / SF / IL / US-Remote (sponsorship-friendly)',
    summary:
      'Applied AI engineer (M.S. Computer Science, Kent State, May 2025; F-1 OPT; 2.5+ yrs production) building RAG over sensitive corpora, multi-agent pipelines with schema discipline, and audit-ready production AI - the architectural pattern Closure\'s law-enforcement search and discovery charter needs at founding-team scale. Production RAG: recursive semantic chunking + transformer embeddings lifted contextual retrieval precision ~35%, retrieval-grounded response alignment >90%, irrelevant retrieval cut >30% over regulated clinical knowledge. Five-agent Healthcare Claims pipeline with schema-validated JSON contracts (pydantic) between Intake / Validation / Consistency / Duplicate / Risk Scoring agents prevents cascading hallucinations and produces audit-ready reasoning traces - the same property a law-enforcement evidence pipeline needs. Vector-indexed CPT/ICD validation + ANN similarity for duplicate detection. FastAPI + Docker production with structured logging and load simulation cut post-deploy defects ~30% under HIPAA-conscious data governance. Founding-team execution evidence: Manga Lens shipped solo to Chrome Web Store - TypeScript Manifest V3 service workers, multi-provider AI vision routing across 4 providers (Claude / GPT-4o mini / GPT-4.1 Nano / Ollama) with per-provider payload abstraction (WebP cloud, JPEG Ollama after CUDA crashes), 7-day translation cache, 29 site selectors. Dream Decoder: full-stack React/TypeScript/Vite/Tailwind + FastAPI with intermediate structured-prompt transformation layer - alignment +30%, first-pass success +25-30%.',
    competencies: [
      'RAG over Sensitive Corpora',
      'Multi-Agent Pipelines + Schema Contracts',
      'Vector Search + Embeddings',
      'Evaluation Pipelines + Audit Trails',
      'Python + FastAPI Production',
      'Docker + Structured Logging',
      'TypeScript + React',
      'Solo-Ship Velocity',
      'Regulated-Domain AI Discipline',
      'F-1 OPT, Sponsorship-Friendly',
    ],
  },
  {
    slug: 'hig-capital-fde-ai-specialist-2026-05-04',
    location_suffix: 'US-based, F-1 OPT, US-Remote ready, open to 40% travel within US',
    summary:
      'Applied AI engineer (M.S. Computer Science, Kent State, May 2025; F-1 OPT; 2.5+ yrs production) shipping multi-provider AI integrations, production prompt engineering, and audit-ready agentic pipelines on compressed timelines - directly transferable to a Forward-Deployed AI Specialist embedding into PE portfolio companies and shipping AI automation across industries. Manga Lens shipped solo to Chrome Web Store: TypeScript Manifest V3 service workers, multi-provider AI vision routing across 4 providers (Claude / GPT-4o mini / GPT-4.1 Nano / Ollama) with per-provider payload abstraction (WebP cloud, JPEG Ollama after CUDA crashes), 7-day translation cache, 29 site selectors - production engineering discipline at customer-facing scale. Five-agent Healthcare Claims pipeline with schema-validated JSON contracts (pydantic) between Intake / Validation / Consistency / Duplicate / Risk Scoring agents prevents cascading hallucinations with audit-ready reasoning traces. Production RAG: recursive semantic chunking + transformer embeddings lifted contextual retrieval precision ~35%, retrieval-grounded response alignment >90%, irrelevant retrieval cut >30%. Dream Decoder: intermediate structured-prompt transformation layer between user input and Replicate / Perplexity APIs lifted alignment ~30% and first-pass image success ~25-30% - prompt engineering is infra. FastAPI + Docker production with structured logging and load simulation cut post-deploy defects ~30%. AI consulting + SaaS healthcare client engagement at Progress Solutions - the same client-engagement reflex PE portfolio embedding needs.',
    competencies: [
      'Multi-Provider AI Routing (Claude / Codex / Gemini / Cursor)',
      'Production Prompt Engineering',
      'Python + TypeScript / JavaScript',
      'API Integrations + Webhook-Adjacent',
      'FastAPI + Docker Production',
      'Schema-Validated Multi-Agent Pipelines',
      'Multi-Provider Build-vs-Buy Abstractions',
      'Solo Ship Velocity (Chrome Web Store)',
      'Compressed-Timeline Delivery',
      'F-1 OPT, US-Remote, 40% Travel-OK',
    ],
  },
];
...
const dateFolder = 'output/2026-05-04';
