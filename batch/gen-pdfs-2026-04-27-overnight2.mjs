#!/usr/bin/env node
// Overnight batch PDF generator for 2026-04-27 — pipeline reports #214-219 (score >= 3.0).
...
const ROLES = [
  {
    slug: 'supabase-ai-tooling-2026-04-27',
    company: 'Supabase',
    role: 'AI Tooling Engineer',
    summary:
      'Applied AI engineer who ships production AI tooling end-to-end across Python and TypeScript. Manga Lens (live in Chrome Web Store) integrates four AI vision providers (Claude / GPT-4o mini / GPT-4.1 Nano / Ollama) with per-provider isolation and Manifest V3 service workers. Healthcare RAG with recursive semantic chunking and transformer embeddings improved retrieval precision ~35% with >90% grounded alignment. Dream Decoder full-stack TS/React/FastAPI multimodal app shows DX taste — intermediate structured-prompt transformation lifted contextual alignment ~30%. Comfortable shipping AI tools, MCP-style integrations, and dashboard AI assistants in a fully-distributed, async, OSS-leaning environment.',
    competencies: [
      'AI Tooling',
      'MCP / Tool Servers',
  ...
  {
    slug: 'firecrawl-fde-integrations-2026-04-27',
    company: 'Firecrawl',
    role: 'Forward Deployed Engineer (Integrations)',
    summary:
      'Forward-deployed Applied AI engineer who ships customer-facing integrations end-to-end. Manga Lens (live in Chrome Web Store) handles 29 site-specific selector configs and viewport-slice screenshot pipelines — pattern-recognition muscle that translates directly to web extraction. Dream Decoder orchestrates Perplexity Sonar + Replicate behind a FastAPI multimodal pipeline. Healthcare RAG with semantic chunking and transformer embeddings improved retrieval precision ~35% with >90% grounded alignment. Production FastAPI / Docker services with structured logging cut post-deploy defects ~30%. Comfortable writing real code, debugging real systems, and turning customer needs into shipped solutions fast.',
    competencies: [
  ...
  {
    slug: 'ascertain-fde-remote-2026-04-27',
    company: 'Ascertain',
    role: 'Forward Deployed Engineer - Remote',
    summary:
      'Forward-deployed Applied AI engineer specialized in healthcare AI agents for care-team admin work. Healthcare RAG with recursive semantic chunking and transformer embeddings improved retrieval precision ~35% and reduced irrelevant retrieval >30%. Agentic LLM workflows for eligibility checks, care workflow navigation, and documentation clarification raised response stability ~25% and cut hallucinations >30%. Predictive ML for patient no-show and care engagement scoring lifted recall 15-20% on high-risk categories while holding precision >90%. FastAPI / Docker production services with HIPAA-conscious governance, structured logging, and audit trails cut post-deploy defects ~30%. Stakeholder-facing system-limitation docs translate directly to embedded customer delivery at health systems.',
    competencies: [
      'Healthcare AI',
  ...
  {
    slug: 'deepintent-applied-ai-2026-04-27',
    company: 'DeepIntent',
    role: 'Applied AI Engineer',
    summary:
      'Applied AI engineer embedded with business teams to ship AI agents for ops automation. Multi-agent healthcare claims pipeline (Intake → Validation → Consistency → Duplicate → Risk Scoring) uses schema-validated JSON contracts to prevent cascading hallucinations and RAG-grounded CPT/ICD validation against vector-indexed policies. Manga Lens (live in Chrome Web Store) integrates four AI providers (Anthropic Claude / GPT-4o mini / GPT-4.1 Nano / Ollama) with per-provider payload routing. Healthcare RAG with semantic chunking and transformer embeddings improved retrieval precision ~35% with >90% grounded alignment. FastAPI / Docker production services with structured logging cut post-deploy defects ~30%. Eastern Time native (Ohio); MS Computer Science (Kent State).',
    competencies: [
  ...
  {
    slug: 'phonely-fde-2026-04-27',
    company: 'Phonely',
    role: 'Forward Deployed Engineer',
    summary:
      'Forward-deployed Applied AI engineer who owns the LLM and agent layer end-to-end. Multi-agent healthcare claims pipeline uses schema-validated JSON contracts to prevent cascading hallucinations. Healthcare RAG with semantic chunking and transformer embeddings improved retrieval precision ~35% with >90% grounded alignment; agentic LLM workflows lifted response stability ~25% and cut hallucinations >30%. Manga Lens (live in Chrome Web Store) integrates four AI providers with per-provider isolation and payload routing. FastAPI / Docker production services with structured logging cut post-deploy defects ~30%; SQL Server DMV + Grafana monitoring at Emerson cut incident recurrence ~25%. Open to SF relocation; ready to ramp on voice-AI telephony stack.',
    competencies: [
      'Forward Deployed Engineering',
      'AI Agents',
      'LLM Production',
...
const PROJECTS = `
    ...
    <div class="project">
      ...
      <div class="project-desc">Real-time computer vision for driver drowsiness; unified YOLOv8 detection + classification head cut inference latency ~30%. Sliding-window confidence aggregation cut false positives ~25%.</div>
...
const dateFolder = 'output/2026-04-27';
