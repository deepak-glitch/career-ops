#!/usr/bin/env node
// One-off tailoring helper for overnight 2026-04-30 batch2 (Corvera, Gecko, Remesh).
...
const ROLES = {
  'corvera-founding-fde': {
    summary: `${BASE} Targeting Founding Forward Deployed Engineer roles inside agentic AI startups - direct customer scoping, agent-driven workflow design, schema-validated reliability, and end-to-end ownership from problem to production in days, not quarters.`,
    comps: ['Founding Engineering', 'Agentic Workflows', 'Customer-Embedded Delivery', 'Schema Contracts', 'Production Reliability', 'Python / FastAPI', 'LangChain / Agents', 'End-to-End Ownership', 'Multi-Provider LLM', 'Docker / CI-CD'],
  },
  'gecko-robotics-fde': {
    summary: `${BASE} Targeting Forward Deployed Engineer roles at industrial / critical-infrastructure platforms - high-impact problem solving across cashflow, production, safety, and environment, with multi-domain breadth (healthcare RAG + computer vision + IoT time-series + graph analysis) backing customer-embedded delivery.`,
    comps: ['Forward Deployed Engineering', 'Multi-Domain Problem Solving', 'Real-Time Computer Vision', 'Industrial AI', 'Python / JavaScript / React', 'Cloud Deployment (GCP / AWS)', 'Customer-Embedded Delivery', 'End-to-End Ownership', 'YOLOv8 / Edge Inference', 'Data Structures / Graphs'],
  },
  'remesh-swe': {
    summary: `${BASE} Targeting AI-first Software Engineering roles where Claude Code / Cursor / multi-provider LLM integration are part of the daily workflow - production agentic systems, schema-validated reliability, and full-stack delivery (TypeScript/React + Python/FastAPI) shipped in fast-moving cross-functional teams.`,
    comps: ['AI-First Engineering', 'Multi-Provider LLM Integration', 'Agentic Workflows', 'TypeScript / React', 'Python / FastAPI', 'Schema Contracts', 'Production Web Engineering', 'LLM API Integration', 'Cross-Functional Delivery', 'Docker / CI-CD'],
  },
};
...
if (targets.length === 0) {
  console.log('Usage: node tailor-pdf-overnight-2026-04-30-batch2.mjs <slug>...');
