#!/usr/bin/env node
/**
 * tailor-pdfs-batch.mjs — Generate tailored ATS PDFs for a batch of roles.
 * Shares template + content layout with regen-all.mjs but accepts tailored
 * summary + reordered competencies per slug.
 */
...
const JOBS = [
  {
    slug: 'anthropic-applied-ai-startups-2026-04-24',
    summary: "Applied AI engineer — 2.5 yrs shipping production RAG (~35% retrieval precision, >90% grounded alignment), agentic LLM workflows (>30% hallucination reduction), and evaluation frameworks in regulated healthcare. Solo-shipped Manga Lens to the Chrome Web Store with 4 LLM vision providers under per-provider failure isolation. Builder credibility + production rigor for Applied AI Engineer, Startups roles.",
    competencies: [
      'Applied AI / LLMs', 'Prompt Engineering', 'Agent Architectures', 'Evaluation Frameworks',
      'RAG + Grounding', 'Python / FastAPI', 'Claude API', 'Multi-Provider Runtime', 'Startup 0-to-1', 'Docker',
    ],
  },
  {
    slug: 'glean-founding-fde-2026-04-24',
    summary: "Applied AI engineer — 2.5 yrs production RAG + agentic + ML pipelines with measurable gains (~35% retrieval precision, >30% hallucination reduction, +15-20% recall). Shipped-solo 0-to-1 builder (Chrome Web Store multi-provider extension, multi-agent claims pipeline, multimodal creative platform). Ready to embed with enterprise customers and translate ambiguous problems into production AI.",
    competencies: [
  ...
  {
    slug: 'glean-ml-evals-observability-2026-04-24',
    summary: "Applied AI engineer — 2.5 yrs production RAG + LLM evaluation frameworks in regulated healthcare. Shipped eval harness with ~90% grounded alignment and ~35% retrieval precision gain; agentic grounding cut hallucinations >30% with ~25% stability lift. Production observability via structured logging, defect reduction ~30%. Ready to scale LLM-judge + trace observability to enterprise work-AI.",
    competencies: [
      'LLM Evaluation', 'LLM-Judge', 'Golden Datasets', 'Grounding', 'Trace Observability',
      'RAG + Retrieval', 'Python / FastAPI', 'Structured Logging', 'Distributed Pipelines', 'Agentic Evals',
    ],
  },
  {
    slug: 'glean-agentic-runtime-2026-04-24',
    summary: "Applied AI engineer — shipped multi-provider agentic runtime (4 LLM vision providers w/ per-provider payload isolation) and production RAG + agentic pipelines in regulated healthcare. ~3.5 yrs building Python backend + Docker deployment + structured logging + Grafana dashboards. Ready to own runtime services (session lifecycle, tool execution, memory, guardrails) for enterprise agents.",
    competencies: [
      'Agentic Runtime', 'Tool Execution', 'Multi-Provider Routing', 'Fault Isolation',
      'Guardrails', 'Session Lifecycle', 'Python / Go', 'Docker', 'Structured Logging', 'LLM APIs',
    ],
  },
  {
    slug: 'arize-ai-solutions-engineer-2026-04-24',
    summary: "Applied AI engineer — shipped production RAG eval harness (~90% grounded alignment, ~35% retrieval precision gain) + agentic grounding (>30% hallucination reduction) in regulated healthcare. Comfortable translating technical depth to both technical and business stakeholders via system-limitation docs and eval reports. Ready to embed as a Solutions Engineer with ML/GenAI teams on observability + evaluation.",
    competencies: [
      'LLM Observability', 'Evaluation Pipelines', 'Grounding', 'Production LLM',
      'Customer Communication', 'RAG + Retrieval', 'Python', 'LangChain / LlamaIndex', 'PyTorch / sklearn', 'Agentic',
    ],
  },
];
