#!/usr/bin/env node
// Overnight 2026-04-30 batch 5 — EvolutionIQ Senior AI/ML Engineer (LLMs).
...
const ROLES = {
  'evolutioniq-llm': {
    summary: `${BASE} Targeting Applied AI / LLM Engineer roles for medical document understanding and claim synthesis — hybrid statistical ML + LLM + RAG pipelines, embeddings and vector search, prompt engineering and LLM evaluation, agentic multi-agent orchestration with schema contracts, and HIPAA-conscious governance for regulated healthcare and insurance domains.`,
    comps: ['Applied AI Engineering', 'LLM Application Development', 'Medical Document RAG', 'Hybrid Statistical ML + LLM', 'Agentic Workflows', 'Schema Contracts', 'Embeddings / Vector Search', 'Prompt Engineering + Evaluation', 'HIPAA-Conscious Governance', 'FastAPI + Docker Production'],
  },
};
...
if (targets.length === 0) {
  console.log('Usage: node tailor-pdf-overnight-2026-04-30-batch5.mjs <slug>...');
