#!/usr/bin/env node
// One-off tailoring helper for overnight 2026-04-30 batch.
...
const ROLES = {
  'innovaccer-fde-3823': {
    summary: `${BASE} Targeting Forward Deployed Engineer roles inside healthcare AI platforms — production triage, backend refactoring, and reproducible test cases that unblock offshore teams while keeping HIPAA-conscious shipping discipline intact.`,
    comps: ['Forward Deployed Engineering', 'Healthcare AI', 'Production Triage', 'Backend Refactoring', 'RAG + Grounding', 'Python / FastAPI', 'Schema Contracts', 'Structured Logging', 'Eval Harnesses', 'Docker / CI-CD'],
  },
  'adobe-fde-ai': {
    summary: `${BASE} Targeting Forward Deployed AI Engineer roles co-developing GenAI proof points with enterprise customers — multi-provider LLM integration (OpenAI / Anthropic / Llama / Mistral), diffusion-model pipelines, RAG and agent frameworks, and React/Node/Python full-stack delivery in fast-moving customer engagements.`,
    comps: ['Forward Deployed Engineering', 'GenAI Customer Co-Development', 'Multi-Provider LLM Integration', 'RAG + Diffusion + Agents', 'Python / FastAPI', 'TypeScript / React / Node', 'Schema Contracts', 'Eval Harnesses', 'Docker / CI-CD', 'Customer-Facing Delivery'],
  },
};
...
if (targets.length === 0) {
  console.log('Usage: node tailor-pdf-overnight-2026-04-30.mjs <slug>...');
