...
PROMPT=$(cat <<'EOF'
You are running the career-ops overnight automation for Deepak Mallampati's job search. Execute in this exact order across BOTH US and Intl tracks, committing and pushing after each major step.
