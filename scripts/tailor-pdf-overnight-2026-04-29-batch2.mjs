#!/usr/bin/env node
// Per-role tailoring helper for overnight 2026-04-29 second batch.
...
const ROLES = {
  'postman-fde': {
    summary: `${BASE} Targeting Forward Deployed Engineer roles embedded with customers at the intersection of product, engineering, and GTM — translating real-world API and integration workflows into hardened, production-shaped solutions.`,
    comps: ['Forward Deployed Engineering', 'Customer-Facing Delivery', 'API & Integration Workflows', 'Python / FastAPI', 'TypeScript / React', 'Multi-Provider LLM Abstraction', 'Schema Contracts', 'Eval Harnesses', 'Docker / CI-CD', 'Production Hardening'],
  },
  'workato-fde-agentic': {
    summary: `${BASE} Targeting Forward Deployed Agentic AI roles operationalizing multi-agent orchestration, RAG, and grounded LLM workflows on top of enterprise integration platforms — translating customer iPaaS scenarios into production-grade agentic solutions.`,
    comps: ['Agentic AI Systems', 'Multi-Agent Orchestration', 'RAG + Grounding', 'Prompt Engineering', 'Memory & Behavior Planning', 'Python / FastAPI', 'API + Integration Workflows', 'Schema Contracts', 'Eval Harnesses', 'Docker / CI-CD'],
  },
  'nira-energy-fde': {
    summary: `${BASE} Targeting Forward Deployed Engineer roles owning end-to-end customer deployments in mission-driven verticals — sitting with operators, absorbing their workflow, and shipping production-shaped systems that match how they actually work.`,
    comps: ['Forward Deployed Engineering', 'Customer-Embedded Delivery', 'End-to-End Ownership', 'Python / FastAPI', 'TypeScript / React', 'Production Hardening', 'Schema Contracts', 'Eval Harnesses', 'Docker / CI-CD', 'Founder Mindset'],
  },
  'panopto-ai-engineer': {
    summary: `${BASE} Targeting Applied AI Engineer roles defining technical direction for AI-powered features at scale — intelligent search, tutoring, and bridging classical engineering teams into AI-fluent contributors.`,
    comps: ['Applied AI / LLMs', 'RAG + Intelligent Search', 'Multi-Provider LLM (Anthropic, OpenAI, Google)', 'Semantic Retrieval + Embeddings', 'Eval Harnesses', 'Production ML Pipelines', 'Python / FastAPI', 'Docker / CI-CD', 'Schema Contracts', 'Mentoring & Knowledge Transfer'],
  },
};
