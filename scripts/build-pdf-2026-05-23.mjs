#!/usr/bin/env node
// One-shot PDF builder for 2026-05-23 overnight batch (#953-#957 minus low-scores).
// Mirrors regen-all.mjs structure but accepts per-evaluation summary override.
...
const JOBS = [
  {
    slug: 'eleos-health-ai-builder',
    track: 'us',
    summary: "Targeting Applied AI / Workflow Automation roles where agentic LLM systems and HIPAA-conscious delivery are the core: behavioral-health and healthcare-ops AI Builder, copilot, and automation roles.",
  },
  {
    slug: 'mirage-software-engineer-early-career',
    track: 'us',
    summary: "Targeting Applied AI / Software Engineering roles at frontier generative-media and AI-native product startups: ship end-to-end product experiences with state-of-the-art multimodal models (video, audio, image, text).",
  },
  {
    slug: 'axiomatic-ai-fde',
    track: 'intl',
    summary: "Targeting Forward Deployed Engineer roles delivering agentic AI systems into regulated and technically-deep enterprise verticals (healthcare, scientific computing, EDA-adjacent).",
  },
  {
    slug: 'yld-ai-engineer',
    track: 'intl',
    summary: "Targeting Generative AI / RAG Engineer roles in client-facing AI consultancies: production RAG, embeddings, vector search, agentic features built in Python and TypeScript on AWS / Docker.",
  },
];
