#!/usr/bin/env node
// Overnight 2026-05-02 — Bask Health (score >= 3.0).
...
const PROJECTS = `
    ...
    <div class="project">
      <span class="project-title">Video Summarization &amp; Highlight Generation (Suvidha Foundation)</span>
      <div class="project-desc">Transformer-based hierarchical abstractive summarization mapped back to source timestamps for automated clip extraction. <strong>60-70% reduction</strong> in manual review time, <strong>~85% highlight alignment</strong> with human curation, Flask-based API for non-technical users.</div>
      <div class="project-tech">PyTorch, Transformers, Flask, video analytics</div>
    </div>
    <div class="project">
...
const SKILLS = `
    ...
    <span class="skill-item"><span class="skill-category">LLM / GenAI:</span> RAG, agentic workflows, structured outputs, evaluation pipelines, guardrails, grounding, embeddings, vector search, LangChain, LlamaIndex, Hugging Face Transformers</span>
    ...
    <span class="skill-item"><span class="skill-category">Domains:</span> Healthcare AI (HIPAA-conscious), Applied AI, Computer Vision, Predictive ML, Multimodal Systems</span>`;
...
if (targets.length === 0) {
  console.log('Usage: node tailor-pdf-overnight-2026-05-02.mjs <slug>...');
