#!/usr/bin/env node
// One-shot PDF builder for 2026-05-29 overnight batch (#1010, #1011, #1012).
// Mirrors scripts/build-pdf-2026-05-23.mjs structure with per-evaluation summary override.
...
const PROJECTS = `
    ...
    <div class="project">
      ...
      <div class="project-desc">Real-time manga translation extension shipped to the Chrome Web Store. Multi-provider abstraction (4 AI vision providers including Claude Sonnet) with per-provider payload handling for worst-case failure isolation. 29 sites supported across manifest V3 service workers.</div>
...
const JOBS = [
  {
    slug: 'automat-fde',
    track: 'us',
    summary: "Targeting Forward Deployed Engineer roles at AI-enabled RPA + IDP startups: ship production browser-automation + LLM-grounded workflows into enterprise legacy systems (Selenium / Playwright / Manifest V3 internals + agentic orchestration).",
  },
  {
    slug: 'aimpoint-fde-claude',
    track: 'us',
    summary: "Targeting Forward Deployed AI Engineer roles delivering Claude-based agentic workflows, knowledge assistants, and decision-support systems into regulated enterprise clients (RAG + LangGraph + FastAPI + HIPAA-conscious patterns).",
  },
  {
    slug: 'crustdata-fde',
    track: 'us',
    summary: "Targeting first-FDE roles at profitable, fast-growing B2B data-API startups: build prototypes/POCs that close deals, ship customer integrations, and turn one-off solutions into reusable templates (Python + TS + SQL + ETL/ELT + data modeling).",
  },
];
