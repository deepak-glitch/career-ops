#!/usr/bin/env node
// One-off tailoring helper for overnight 2026-04-30 batch3 (Handshake, AHEAD).
...
const ROLES = {
  'handshake-fde': {
    summary: `${BASE} Targeting Associate Forward Deployed Engineer roles partnering with AI labs and enterprise customers - ReactJS / TypeScript front-of-stack, PostgreSQL data modeling, FastAPI / Docker production discipline, multi-provider LLM integration, and rapid prototype-to-deploy delivery alongside senior engineers.`,
    comps: ['Forward Deployed Engineering', 'Customer-Embedded Delivery', 'ReactJS / TypeScript', 'PostgreSQL Data Modeling', 'Multi-Provider LLM', 'FastAPI / Docker', 'Schema Contracts', 'Rapid Prototyping', 'Cloud Deployment (AWS / GCP)', 'Cross-Functional Communication'],
  },
  'ahead-ai-services': {
    summary: `${BASE} Targeting Applied AI Engineer roles in enterprise AI Services - multi-agent workflows on LangChain / LangGraph, RAG pipelines with pgvector / Pinecone / Elasticsearch, enterprise integrations, observability for agentic systems, and HIPAA-parallel compliance discipline transferable to Salesforce / ServiceNow / SAP environments.`,
    comps: ['Multi-Agent Workflows', 'LangChain / LangGraph', 'RAG / Vector Search', 'Enterprise Integration', 'Production Reliability', 'Compliance-Aware AI', 'Schema Contracts', 'Customer-Embedded Delivery', 'Observability', 'Python / FastAPI'],
  },
};
...
const PROJECTS = `
    ...
    <div class="project">
      ...
      <div class="project-desc">Bottle + SQLite relational healthcare CRUD app with normalized patients/diagnoses schema, FK constraints, application-layer cascade deletes, and LEFT JOIN + GROUP_CONCAT for single-query patient+diagnosis retrieval.</div>
      <div class="project-tech">Python, Bottle, SQLite, relational data modeling</div>
    </div>`;
...
if (targets.length === 0) {
  console.log('Usage: node tailor-pdf-overnight-2026-04-30-batch3.mjs <slug>...');
