#!/usr/bin/env node
// Per-role tailoring helper for overnight 2026-04-29 third batch (#268-274).
...
const ROLES = {
  'axiomatic-ai-applied-ai': {
    summary: `${BASE} Targeting Applied AI Engineer roles building production LLM features end to end with LangChain, PydanticAI, and Knowledge Graph reasoning — translating research-grade ideas into observable, schema-grounded systems.`,
    comps: ['Applied AI / LLMs', 'LangChain + PydanticAI', 'OpenAI / Anthropic / Hugging Face', 'RAG Architectures', 'Knowledge Graphs', 'Python / FastAPI', 'Docker / GitHub Actions', 'Schema Contracts', 'Eval Pipelines', 'Production Observability'],
  },
  'human-agency-applied-ai': {
    summary: `${BASE} Targeting Applied AI Engineer roles in venture-studio and agency contexts — architecting agent-driven workflows and AI-native products across portfolio companies, with end-to-end ownership from discovery to production.`,
    comps: ['Applied AI / LLMs', 'Agent-Driven Workflows', 'OpenAI / Anthropic', 'LangChain / LlamaIndex', 'Vector Databases', 'Full-Stack Delivery', 'Python / FastAPI', 'TypeScript / React', 'Schema Contracts', 'Founder-Loop Shipping'],
  },
  'gradial-applied-ai': {
    summary: `${BASE} Targeting Applied AI Engineer roles building autonomous and semi-autonomous agents that interact with browsers, codebases, and APIs — production agentic systems with eval-first design and modular memory/tool/evaluator frameworks.`,
    comps: ['Applied AI / LLMs', 'Agentic Architectures', 'Browser / Code / API Orchestration', 'OpenAI / Anthropic', 'Prompt Engineering', 'RAG + Grounding', 'Eval Pipelines (SWE-bench style)', 'RL + Data-Centric AI', 'Python / TypeScript', 'Schema Contracts'],
  },
  'gradial-fde': {
    summary: `${BASE} Targeting Forward Deployed Engineer roles translating customer workflows into AI-native solutions — TypeScript + APIs + LLM/agent integration with configuration-driven adapter layers built for scalable enterprise onboarding.`,
    comps: ['Forward Deployed Engineering', 'Customer-Embedded Delivery', 'TypeScript / APIs', 'LLM / Agent Integration', 'Configuration / Adapter Layers', 'CMS / DAM / Workflow Tools', 'Python / FastAPI', 'Docker / CI-CD', 'Schema Contracts', 'End-to-End Ownership'],
  },
};
...
if (targets.length === 0) {
  console.log('Usage: node tailor-pdf-overnight-2026-04-29-batch2.mjs <slug>...');
