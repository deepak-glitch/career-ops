#!/usr/bin/env node
// Per-role tailoring helper for overnight 2026-04-29 fourth batch (#275, #278-280).
// Mirrors regen-all.mjs blocks, accepts per-slug summary + competencies tags.
...
const ROLES = {
  'lazarus-fde': {
    summary: `${BASE} Targeting Forward Deployed / Customer Engineering roles for document intelligence and AI platform vendors — Python + LLM + prompt engineering with FastAPI / Docker production discipline and customer-shipped releases.`,
    comps: ['Forward Deployed Engineering', 'Applied AI / LLMs', 'Prompt Engineering', 'Python / FastAPI', 'Docker / CI-CD', 'REST APIs', 'Customer-Embedded Delivery', 'Multi-Provider AI', 'Healthcare AI', 'End-to-End Ownership'],
  },
  'augment-fde': {
    summary: `${BASE} Targeting Forward-Deployed Engineer roles building AI-driven workflows for logistics and operations customers — prompt authoring + log tracing + API integrations + small-but-critical scripts that keep production AI systems running.`,
    comps: ['Forward-Deployed Engineering', 'AI Workflow Automation', 'Prompt Authoring + Testing', 'Log + API Tracing', 'Python / TypeScript / Node.js', 'FastAPI / Docker', 'Configuration / Adapter Layers', 'Customer-Embedded Delivery', 'Multi-Provider AI', 'Schema Contracts'],
  },
  'exa-fde': {
    summary: `${BASE} Targeting Forward Deployed Engineer roles at search and retrieval companies — production RAG with measurable retrieval gains, multi-provider AI shipped to public users, and founder-loop full-stack delivery; equally comfortable on customer calls and in the codebase.`,
    comps: ['Forward Deployed Engineering', 'Search + Retrieval', 'Embeddings + Vector Search', 'RAG + Grounding', 'Customer-Facing Engineering', 'Full-Stack Delivery', 'Python / TypeScript / Node.js', 'FastAPI / Docker', 'Multi-Provider AI', 'Founder-Loop Shipping'],
  },
  'fractional-ai-fde': {
    summary: `${BASE} Targeting Forward-Deployed Software Engineer roles for healthcare and life sciences AI consulting — HIPAA-conscious end-to-end delivery from scoping to production, schema-validated agentic pipelines, and audit-ready evaluation artefacts that meet enterprise governance bars.`,
    comps: ['Forward-Deployed Engineering', 'Healthcare / Life Sciences AI', 'HIPAA-Conscious Delivery', 'Agentic Pipelines + Schema Contracts', 'RAG + Grounding', 'Eval Audit Trails', 'Python / FastAPI', 'Docker / CI-CD', 'End-to-End Ownership', 'Founding-Team Shipping'],
  },
};
...
if (targets.length === 0) {
  console.log('Usage: node tailor-pdf-overnight-2026-04-29-batch4.mjs <slug>...');
